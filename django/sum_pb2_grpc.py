...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in sum_pb2_grpc.py depends on'
...
class SumServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Add = channel.unary_unary(
                ...
                response_deserializer=sum__pb2.AddResponse.FromString,
...
def add_SumServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Add': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=sum__pb2.AddResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'SumService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('SumService', rpc_method_handlers)
...
class SumService(object):
    ...
    def Add(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            sum__pb2.AddResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
